...
/**
 * The reptile has a sharp rapier.
 * 
...
public class Reptile extends Enemy
{
    ...
    //----- Movement -----
    private static final int walkSpeed = 50;                   //Move 40 pixel per second
    ...
    private static final int damage = 24;                      //Attack damage of this enemy   

    //----- Cooldowns -----
    private static final double hitCooldown = 650000000.0;     //Cooldown of 650 milion nanosec (0,65 sec) between hits
    ...
    //----- Drop item -----
    private static final String[] dropItems = new String[] {"bluePotion", "purplePotion", "rapier", null, null};   //Array that contins the items that will be dropped if this enemy dies
    ...
    //----- Layer images -----    
    private static final GreenfootImage reptile = new GreenfootImage("enemys/reptile.png");
    
    /**
     * Reptile Constructor: Sets the speed, creates the spriteSheet of the character, creates the animations and sets variables.
     * 
     ...
     */ 
    public Reptile(Player newPlayer, EnemyHealthBar newBar, int startDirection)
    {
        //Set the speed
