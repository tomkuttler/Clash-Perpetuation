...
public abstract class Enemy extends AnimatedCharacter
{
    ...
    private double hitCooldown;  //Cooldown of 1 bilion nanosec (1sec) between hits
    ...
    private double removeCooldown; //Object will be removed after Cooldown (after Health <= 0)
